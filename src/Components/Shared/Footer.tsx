...
const Footer = () => {
  return (
    <footer className="w-full bg-gradient-to-br from-blue-100 via-white to-purple-100 pt-8 pb-4 px-4 mt-10 animate-footer-fade-in">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-6 items-start">
        ...
        <div className="flex flex-col items-center md:items-start gap-2 col-span-1">
          ...
          >
            ...
            <button
              type="submit"
              className="px-4 py-3 bg-gradient-to-r from-cyan-500 to-indigo-600 text-white rounded-r-md font-semibold hover:from-purple-600 hover:to-blue-600 transition"
            >
              Subscribe
            </button>
          </form>
      ...
      {/* Footer Bottom */}
      <div className="mt-3 text-center text-gray-500 text-sm animate-footer-fade-in">
        <span>
